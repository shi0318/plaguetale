...
Straight from the official store text:

- Sophia engages in **dynamic and violent melee combat**.
- She is **skilled, agile, and strong-willed**.
- Combat centres on **agility, tricks, and sharp reflexes**.
- You **perfect your parries** and **unleash powerful strikes** to survive deadly encounters.
- Many enemies pursue you, each drawn to the island to reclaim a mysterious treasure — you must **stay one step ahead**.
- Against the creature behind the myth, you **can't stop, only hide, outsmart, and push forward**.

This is a notable shift for the series. The earlier games leaned heavily on **stealth and avoidance**; Resonance foregrounds **direct melee** with parries and strikes as core survival tools.
